...
public final class EncoderImpl implements ByteBufferEncoder
{
    ...
    private final Map<Class, AMQPType> _typeRegistry = new ConcurrentHashMap<Class, AMQPType>();
    private Map<Object, AMQPType> _describedDescriptorRegistry = new ConcurrentHashMap<Object, AMQPType>();
    private Map<Class, AMQPType>  _describedTypesClassRegistry = new ConcurrentHashMap<Class, AMQPType>();
    ...
    void writeRaw(WritableBuffer buffer, String string)
    {
