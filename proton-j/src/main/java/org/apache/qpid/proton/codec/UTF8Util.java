...
public final class UTF8Util {
   ...
   public static void saveUTF(final WritableBuffer out, final String str) {
      ...
      if (len == (long) str.length()) {
         ...
         out.put(buffer.byteBuffer, 0, len);
      }
      else {
   ...
   public static String readUTF(final ReadableBuffer input) {
      StringUtilBuffer buffer = UTF8Util.getThreadLocalBuffer();
      ...
      input.get(buffer.byteBuffer, 0, size);
